//! Isolated benchmark for crossbeam-channel - for perf profiling
//!
//! Run: cargo build --release --bench perf_crossbeam_channel_raw
//! Profile: sudo perf stat -e cycles,instructions,cache-misses,L1-dcache-load-misses \
//!          taskset -c 0,2 ./target/release/deps/perf_crossbeam_channel_raw-*
